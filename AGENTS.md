...
- Public classes and types use the `HY` prefix, custom-element tags use `hy-`, and theme tokens use `--hy-`; do not introduce legacy `GE/ge` aliases.
- Theme styling must flow through inherited semantic custom properties. Do not hard-code product workflow styling or make a component depend on a specific theme file.
